...
public partial class NewsItem: Fuse.Controls.StackPanel
{
    ...
    void InitializeUX()
    {
        ...
        temp_Url_inst = new SocialMediaMock_FuseDrawingImageFill_Url_Property(temp, __selector0);
        var temp10 = new global::Fuse.Reactive.Data("portrait");
        var temp1 = new global::Name();
        temp1_Value_inst = new SocialMediaMock_FuseControlsTextControl_Value_Property(temp1, __selector1);
        var temp11 = new global::Fuse.Reactive.Data("author");
        var temp2 = new global::SubText();
        temp2_Value_inst = new SocialMediaMock_FuseControlsTextControl_Value_Property(temp2, __selector1);
        var temp12 = new global::Fuse.Reactive.Data("postAge");
        var temp3 = new global::SubText();
        temp3_Value_inst = new SocialMediaMock_FuseControlsTextControl_Value_Property(temp3, __selector1);
        var temp13 = new global::Fuse.Reactive.Data("source");
        var temp4 = new global::SubText();
        temp4_Value_inst = new SocialMediaMock_FuseControlsTextControl_Value_Property(temp4, __selector1);
        var temp14 = new global::Fuse.Reactive.Data("location");
        var temp5 = new global::Fuse.Controls.Image();
        temp5_Url_inst = new SocialMediaMock_FuseControlsImage_Url_Property(temp5, __selector0);
        var temp15 = new global::Fuse.Reactive.Data("imageUrl");
        var temp6 = new global::Header();
        temp6_Value_inst = new SocialMediaMock_FuseControlsTextControl_Value_Property(temp6, __selector1);
        var temp16 = new global::Fuse.Reactive.Data("headline");
        var temp7 = new global::Article();
        temp7_Value_inst = new SocialMediaMock_FuseControlsTextControl_Value_Property(temp7, __selector1);
        var temp17 = new global::Fuse.Reactive.Data("body");
        var temp8 = new global::Stat();
        temp8_Value_inst = new SocialMediaMock_FuseControlsTextControl_Value_Property(temp8, __selector1);
        var temp18 = new global::Fuse.Reactive.Data("numLikes");
        var temp9 = new global::Stat();
        temp9_Value_inst = new SocialMediaMock_FuseControlsTextControl_Value_Property(temp9, __selector1);
        ...
        temp31.File = new global::Uno.UX.BundleFileSource(import("../../../../../assets/icon/Location.png"));
        ...
        temp37.File = new global::Uno.UX.BundleFileSource(import("../../../../../assets/icon/Like.png"));
        temp8.Bindings.Add(temp38);
        temp39.File = new global::Uno.UX.BundleFileSource(import("../../../../../assets/icon/Comment.png"));
        temp9.Bindings.Add(temp40);
        temp41.File = new global::Uno.UX.BundleFileSource(import("../../../../../assets/icon/Share.png"));
